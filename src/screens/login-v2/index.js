...
function mapStateToProps(state) {
  return {
    ...
    isLoggingInWithGoogle: state.loadingState.isLoggingInWithGoogle,
    isLoggingInWithApple: state.loadingState.isLoggingInWithApple,
...
const mapDispatchToProps = {
  ...
  requestGoogleLogin: UserCreators.requestGoogleLogin,
  requestAppleLogin: UserCreators.requestAppleLogin,
};
